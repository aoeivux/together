    ...
    , ui(new Ui::MainWindow)
{
    ...
    audioOutput->setVolume(0.1f);           //设置音量
    ...
    ui->seekSlider->setRange(0,player->duration()); //进度条
    ui->volumeSlider->setRange(0,100);      //音量条
    ui->volumeSlider->setValue(10);
    connect(ui->seekSlider, &QSlider::sliderMoved, this, &MainWindow::seek);        //seek事件
    connect(player, &QMediaPlayer::durationChanged, this, &MainWindow::durationChanged);    //视频时长
    connect(player, &QMediaPlayer::positionChanged, this, &MainWindow::positionChanged);    //当前播放位置
//    connect(player, &QMediaPlayer::mediaStatusChanged, this, &MainWindow::handleBuffering);
    connect(ui->buttonPlay, &QPushButton::clicked, this, &MainWindow::playPressed); //播放按钮
    connect(ui->buttonPause, &QPushButton::clicked, this, &MainWindow::pausePressed);   //暂停按钮
    connect(ui->buttonStop, &QPushButton::clicked, this, &MainWindow::stopPressed); //停止按钮
    connect(ui->buttonFullScreen, &QPushButton::clicked, this, &MainWindow::fullScreen);//全屏按钮
}
